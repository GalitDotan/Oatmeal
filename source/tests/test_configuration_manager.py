...
class TestConfigurationManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.update_json_str = codecs.open(os.path.join(dirname, "fixtures/configuration/configuration_update.json"),
                                           'r').read()
        self.illegal_update_json_str = codecs.open(
            os.path.join(dirname, "fixtures/configuration/illegal_configuration_update.json"), 'r').read()
