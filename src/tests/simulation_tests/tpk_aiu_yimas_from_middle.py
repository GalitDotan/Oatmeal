...
from src.tests.otml_with_simualtion import run_simulation
...
configurations_tuples = [
    ...
    ("MAX_FEATURE_BUNDLES_IN_PHONOTACTIC_CONSTRAINT", sys.maxsize),
    ("DATA_ENCODING_LENGTH_MULTIPLIER", 100),
    ("MAX_NUMBER_OF_CONSTRAINTS_IN_CONSTRAINT_SET", sys.maxsize),
